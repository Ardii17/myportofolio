...
const Skills = () => {
  ...
  return (
    <div
      ref={theme?.skillsRef}
      className="w-full lg:h-screen py-6 max-sm:px-8 max-md:px-12 lg:px-14 sm:h-auto bg-center bg-cover bg-no-repeat"
      // data-aos="fade-up"
    ...
    >
      ...
      <p className="text-white mb-10 max-sm:px-4 text-center opacity-70 text-sm">
